 ...
 *      provide information about a uarray2b, which is a unboxed blokcked 2D 
 *      array. These functions are then exported to the a2methods suite of 
...
/* defining a private version of each function in A2Methods_T  */
